...
def main(
    ...
    for k in tqdm(range(1, (len(test_lines) // generalize) + 1)):
        ...
        finer_flag = main_align(store, queries, full_indices, top_k)
...
if __name__ == "__main__":
    ...
    data_queue = args.recipes.split(";")  # Data the was used to train the model
    checkpoint_queue = args.checkpoints.split(";")  # Trained model checkpoints
